...
def calculates_results_stats(results_dic):
    ...
    print("IMAGES OF DOGS: {}".format(results_stats_dic["n_dogs_img"]))
    print("IMAGES OF NON DOGS: {}".format(results_stats_dic["n_notdogs_img"]))
    print("CORRECT DOG IMAGES: {}".format(results_stats_dic["n_correct_dogs"]))
    print("CORRECT NON DOG IMAGES: {}".format(results_stats_dic["n_correct_notdogs"]))
    print("CORRECT DOG BREEDS: {}".format(results_stats_dic["n_correct_breed"]))
    print("NUMBER OF MATCH: {}".format(results_stats_dic["n_match"]))
    ...
    if results_stats_dic['n_notdogs_img'] > 0:
        ...
        results_stats_dic['n_notdogs_img'] = 0.0
